...
function signOut(){
    ...
    firebase.auth().onAuthStateChanged(function(user) {
      if (user) {
        ...
        document.getElementById(`suh`).innerHTML = ` Favourite By ${firebase.auth().currentUser.displayName}`
     ...
     <div class="cardstyling col-lg-4 col-sm-6 portfolio-item">
       <div class="card h-100">
         ...
         <div class="card-body">
           ...
           <button type="button" class="btn btn-danger" onclick="cart('${data}')"><a href="cart.html">Buy now</a></button>
         </div>
       </div>
     </div>
    `
     ...
     //Buy
     function cart(data){
      document.getElementById('buy').innerHTML = data.price;
     }
